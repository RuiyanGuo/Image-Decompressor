...
vlog -sv -work my_work +define+DISABLE_DEFAULT_NET $rtl/RAM_inst0.v
vlog -sv -work my_work +define+DISABLE_DEFAULT_NET $rtl/RAM_inst1.v
vlog -sv -work my_work +define+DISABLE_DEFAULT_NET $rtl/RAM_inst2.v
